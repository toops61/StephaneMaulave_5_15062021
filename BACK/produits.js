fetch('http://localhost:3000/api/teddies')
        ...
        .then(function(value) {          
            for (let i = 0; i < value.length; i++) {
                ...
                productSection.innerHTML += '<a href="./produit.html?id=' + value[i]._id + '" id="lien-product' + i + '"><div class="products__card"><div class="products__card__image" id="teddy-image' + i + '"></div><div class="products__card__description"><h2 id="teddy-name' + i + '"></h2><p id="teddy-price' + i + '"></p></div></div></a>';
